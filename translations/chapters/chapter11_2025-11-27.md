...
**Date:** 2025-11-27 (Revised from 2025-11-26)
**Status:** Scythe operation fully integrated
...
**有 (manifest form) provides 利 (harvest-capacity, the π-operation)**
**無 (preserved void) provides 用 (functional capacity, the space enabling motion)**
...
**All demonstrate the same principle: The void is not absence—it's the operational origin.**

And 利 is not "advantage" abstractly.
**利 is the scythe operation.**
**利 is the π-arc that clears the field.**
...
禾 (standing field) + 刂 (blade arc) = 利 (harvest completed)

有之以為利 (substance provides the π-operation)
無之以為用 (emptiness provides the void enabling arc)

This is not philosophy. This is documentation.
```
